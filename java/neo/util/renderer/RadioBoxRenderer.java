...
/**
 * 	@Class Name	: 	RadioBoxRenderer.java
 * 	@파일설명		: 	
 * 	@Version		: 	1.0
 *	@Author		: 	hoon09
 ...
 **********************************************************************************************             
 */
public class RadioBoxRenderer implements java.io.Serializable {
	...
	public RadioBoxRenderer() {}

	public RadioBoxRenderer(Vector keys,
							String value,
							boolean allSelect,
							String allSect,
							String allDelimiter,
	...
	public RadioBoxRenderer(Vector keys, String value) {
		keys_ = keys;
		value_ = value;
		allSelect_ = false;
	}
