...
/**
 * 	@Class Name	: 	DB2ClientPageStatement.java
 * 	@파일설명		: 	
 * 	@Version		: 	1.0
 *	@Author		: 	hoon09
 ...
 **********************************************************************************************             
 */
public class DB2ClientPageStatement extends AbstractPageStatement {

	public DB2ClientPageStatement(TData pageData) {
		super(pageData);
	}

	public DB2ClientPageStatement(String pageSpec, TData pageData) {
